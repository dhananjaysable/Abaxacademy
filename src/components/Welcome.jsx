  ...
  return (
    <section className="py-12 px-6">
      <div className="container mx-auto">
        <h2 className="text-3xl font-semibold text-center mb-2">Welcome To <span className="text-gray-800 uppercase">Abax Academy</span></h2>
        <div className="w-40 h-1 bg-blue-400 mx-auto mb-8"></div>
        
        <div className="flex flex-col md:flex-row items-center md:space-x-8">
          <div className="md:w-1/2 mb-6 md:mb-0">
            <p className="text-center italic mb-4">Interface Friendly Learning At</p>
            <h3 className="text-center text-blue-500 text-2xl font-bold mb-6">ABAX ACADEMY</h3>
            ...
            <button className="bg-blue-400 text-white px-4 py-1 rounded hover:bg-blue-500">Read more</button>
          </div>
